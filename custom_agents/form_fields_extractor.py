...
async def test_model():
    result = await Runner.run(fields_extractor_agent, """Required Fields: What's your expected monthly basic salary?, How would you rate your English language skills? - Please make a selection
,
